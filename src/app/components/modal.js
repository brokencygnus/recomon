...
export function Modal({ open, setOpen, children, panelTitle }) {
  return (
      ...
      <Dialog className="relative z-10" onClose={setOpen}>
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex h-full items-end justify-center pb-12 pt-24 3xl:pb-20 3xl:pt-32 px-4 text-center sm:items-center">
            ...
            >
              <DialogPanel className="transform max-h-full overflow-y-auto rounded-lg bg-white text-left shadow-xl transition-all">
