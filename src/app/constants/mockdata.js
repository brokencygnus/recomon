...
export const APIs = [
  { id: 1, code: "API-001", name: "Fireblocks API", ageMS: 7527951,
    testResult: "200 OK", testResponse: `{"success": true, "data": { "BTC-A002":"12345678.12345678", "ETH-A001":"12345678.12345678", "BTC-FDA006":"12345678.12345678", "BTC-FDA007":"12345678.12345678", "ETH-FDA002":"12345678.12345678", "ETH-FDA003":"12345678.12345678", "ETH-A001":"12345678.12345678", "SOL-A001":"12345678.12345678" }}`,
  ...
  { id: 2, code: "API-002", name: 'Anchorage API', ageMS: 41357,
    testResult: "421 I'm a teapot", testResponse: `{"success": false, "message": "The requested entity body is short and stout. Tip me over and pour me out." }`,
  ...
  { id: 3, code: "API-003", name: 'Coinbase API', ageMS: 17472025,
    testResult: "431 Request Header Fields Too Large", testResponse: `{"success": false, "message": "Request Header Fields Too Large" }`,
  ...
  { id: 4, code: "API-004", name: 'INDODAX API', ageMS: 477732,
    testResult: "500 Internal Server Error", testResponse: "",
  ...
  { id: 5, code: "API-005", name: 'FalconX API', ageMS: 6149116,
    testResult: "218 This is fine", testResponse: `{ "success": false, "code": "500", "message": "Internal Server Error" }`,
  ...
  { id: 6, code: "API-006", name: 'Internal CAMP API', ageMS: 46343658,
    testResult: "450 Blocked by Windows Parental Controls", testResponse: `{ "success": false, "message": "Windows Parental Controls has blocked access to the requested resource" }`,
...
export const currencies = [
  ...
  { name: 'USD Tether', symbol: 'USDT', convertUSD: "0.99942", is_blockchain: true, networks: ["ERC20", "TRC20"]},
  { name: 'Solana', symbol: 'SOL', convertUSD: "134.19", is_blockchain: true, networks: ["Solana"]},
