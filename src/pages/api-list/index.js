        ...
        <div className="py-4">
          <header>
            <div className="max-w-7xl">
              <h1 className="text-3xl font-bold leading-tight tracking-tight text-gray-900">Manage APIs</h1>
                ...
                {data.map((item) => (
                  <tr key={item.code} className="bg-white hover:bg-gray-50">
                    ...
                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                      <div className="flex justify-between items-center min-w-40 max-w-80">
                        <SeeMore
                          threshold={36}
                          content={item.url}
                        />
...
function TestConnection({ item }) {
  ...
  return (
    <div className="flex flex-col w-72 3xl:w-96">
      <div className="flex flex-row">
        ...
        <div className="flex flex-col 3xl:flex-row items-start 3xl:items-center justify-start">
          ...
          <button
            ...
            {expanded ? "Hide response" : "View response"}<span className="sr-only">, {item.name}</span>
          </button>
        </div>
      </div>
      <div>
        ...
        leaveTo="hidden"
        >
          <div className="mt-3 rounded-md bg-gray-100 px-2.5 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300">
            <span className="font-mono text-wrap break-all">{item?.testResponse ? item.testResponse : "No response body was given from the server."}</span>
          </div>
        </Transition>
      </div>
    </div>
